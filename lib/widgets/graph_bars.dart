...
class GraphBars extends StatefulWidget {
  GraphBars({Key? key}) : super(key: key);

  @override
  State<GraphBars> createState() => _GraphBarsState();
}

class _GraphBarsState extends State<GraphBars> {
